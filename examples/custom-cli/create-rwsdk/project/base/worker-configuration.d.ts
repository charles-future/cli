/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8ae5e95fdf2c7f23043ff78de4c29a64)
...
declare namespace Cloudflare {
  ...
  interface Env {
    ...
    VITE_DATABASE_URL_POOLER: string
    REALTIME_DURABLE_OBJECT: DurableObjectNamespace<
      import('./src/worker').RealtimeDurableObject
    >
    ASSETS: Fetcher
  }
}
...
declare namespace NodeJS {
  interface ProcessEnv
    extends StringifyValues<
      Pick<Cloudflare.Env, 'VITE_DATABASE_URL' | 'VITE_DATABASE_URL_POOLER'>
    > {}
}
